      ...
      transition={{duration:1}}
        ...
        <motion.p
          ...
          transition={{delay:0.7, duration:0.5}}
            ...
            className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>I love to hear from you. Whether you have a question or just want to chat about design, tech & art — shoot me a message.</motion.p>
