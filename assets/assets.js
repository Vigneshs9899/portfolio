...
export const serviceData = [
    ...
    { icon: assets.web_icon, title: 'Company Profile Website (HTML, Tailwind CSS, JavaScript)', description: 'Developed a modern, responsive website to showcase company services and portfolio.', link: 'https://vigneshs9899.github.io/company_website/' },
    { icon: assets.web_icon, title: 'Dynamic Portfolio Website (Next.js, Framer Motion)', description: 'Created a personal portfolio website with dynamic animations using Framer Motion library.', link: '#' },
]

export const infoList = [
    { icon: assets.code_icon, iconDark: assets.code_icon_dark, title: 'Languages', description: 'HTML, CSS - Tailwind & Bootstrap, JavaScript, React Js, Next Js, Python, MySQL, Git' },
    { icon: assets.edu_icon, iconDark: assets.edu_icon_dark, title: 'Education', description: 'M.sc in Computer Science B.sc in Computer Science' },
    { icon: assets.project_icon, iconDark: assets.project_icon_dark, title: 'Projects', description: 'Built more than 5 sample projects and 10+ live projects' }
];
